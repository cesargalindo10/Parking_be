...
COPY public.reserva (id, estado, fecha_inicio, fecha_fin, cliente_id, plaza_id, tarifa_id, cantidad, couta) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.pago_id_seq', 41, true);
...
SELECT pg_catalog.setval('public.reserva_id_seq', 45, true);
